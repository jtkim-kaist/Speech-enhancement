...
clean_dir = config.small_test_clean_path
noisy_dir = config.small_test_noisy_path
norm_dir = config.norm_path
...
if __name__ == '__main__':
    ...
    # graph_name = sorted(glob.glob(model_dir + '/*.pb'))[-1]
    graph_name = '/home/jtkim/hdd3/github_2/SE_graph/FNN/FNN.pb'
